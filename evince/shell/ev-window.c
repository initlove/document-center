...
static void
ev_change_dc_mode (EvWindow *window, gboolean dc)
{
//dliang
	if (dc) {
...
static void
ev_window_dc_open (GtkAction *action, EvWindow *window)
{
//dliang
	ev_change_dc_mode (window, TRUE);
}
...
static const GtkActionEntry entries[] = {
	...
	{ "DocumentCenterOpen", GTK_STOCK_OPEN, N_("Open Document Center"), NULL,
	  N_("Open the document center"),
	  G_CALLBACK (ev_window_dc_open) },
	/* File menu */
...
//dliang mark
	...
	ev_view_set_page_cache_size (EV_VIEW (ev_window->priv->view),
				     page_cache_mb * 1024 * 1024);
//dliang mark, we load model here
...
//dliang
	ev_change_dc_mode (ev_window, TRUE);
}
